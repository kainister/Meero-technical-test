...
class CmdDeleteTest extends KernelTestCase
{
    ...
    public function testExecute()
    {
        ...
        $command = $application->find('meero:area:remove');
        ...
        $this->assertContains('entity "62b75357-ddde-458d-9f1c-a01867cd8dad" removed ', $output);
    }

    public function testExecuteWithBadId()
    {
        // insert tests data into the database
        $this->connection->insert('area', [
                'id' => '62b75357-ddde-458d-9f1c-a01867cd8dad',
        ...
        $commandTester->execute([
            'command' => $command->getName(),
            'uuid' => '62b75357-ddde-458d-9f1c-a01867cd8123',
        ]);

        $output = $commandTester->getDisplay();

        $this->assertEquals(255, $commandTester->getStatusCode());
        $this->assertContains('entity "62b75357-ddde-458d-9f1c-a01867cd8123" not found', $output);
    }
}
